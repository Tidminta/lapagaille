...
/*   Updated: 2020/06/06 18:59:29 by tidminta         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					get_next_line(int fd, char **line)
{
	...
	if (ft_check(fd, line, &str, buff) == -1)
		return (-1);
	while ((!ft_strchr2(str, 10)) && ((rd = read(fd, buff, BUFFER_SIZE))))
	{
		if (rd == -1)
			return (-1);
